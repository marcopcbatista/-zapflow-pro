...
import { Play, CheckCircle2, Users, MessageSquare, TrendingUp, Star, ChevronDown, Menu, X, Zap, Shield, Clock, BarChart3, Bot, Headphones } from 'lucide-react';
...
function App() {
  ...
  const checkoutUrl = 'https://pay.kiwify.com.br/XxlKJT4';
            ...
            <div className="space-y-8">
              <div className="inline-block">
                <span className="bg-gradient-to-r from-pink-500 to-purple-600 px-6 py-2 rounded-full text-sm font-semibold shadow-lg">
                  🚀 7x Revolucione seu atendimento
                </span>
              </div>
            ...
            {[
              {
                ...
                description: "IA que responde clientes 24/7 com taxa de resolução de 87%"
              },
              {
                icon: <Zap className="w-8 h-8" />,
                title: "Respostas Rápidas",
                description: "Templates inteligentes que economizam 4h/dia da sua equipe"
              },
              {
                icon: <Users className="w-8 h-8" />,
                title: "CRM Integrado",
                description: "Gestão completa de contatos e histórico de conversas"
              },
              {
                icon: <BarChart3 className="w-8 h-8" />,
                title: "Análise em Tempo Real",
                description: "Dashboard com métricas que importam: conversão, tempo de resposta, ROI"
              },
              {
                icon: <MessageSquare className="w-8 h-8" />,
                title: "Envio em Massa",
                description: "Campanhas personalizadas que não são bloqueadas"
              },
              {
                icon: <Shield className="w-8 h-8" />,
                title: "100% Seguro",
                description: "API oficial do WhatsApp - zero risco de ban"
              }
            ].map((feature, index) => (
      ...
      <section id="depoimentos" className="py-20 px-4 sm:px-6 lg:px-8 bg-purple-900/30">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-purple-200">Resultados reais de empresas reais</p>
          </div>
            ...
            {[
              {
                ...
                text: "Aumentamos as vendas em 340% no primeiro mês. O ROI foi absurdo!"
              },
              {
                name: "Mariana Costa",
                role: "Gerente, Fashion House",
                image: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?auto=format&fit=crop&q=80&w=200",
                text: "Reduzimos o tempo de resposta de 2h para 30 segundos. Clientes adoram!"
              },
              {
                name: "Pedro Santos",
                role: "Fundador, EduOnline",
                image: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&q=80&w=200",
                text: "Automatizamos 80% do atendimento e dobramos a equipe de vendas."
              }
      ...
      <footer className="py-12 px-4 sm:px-6 lg:px-8 bg-purple-950/50">
        <div className="max-w-7xl mx-auto text-center">
          <p className="text-purple-300">
            ...
            <a href="#" className="hover:text-white ml-2">Termos</a> | 
            <a href="#" className="hover:text-white ml-2">Privacidade</a>
          </p>
        </div>
      </footer>
    </div>
