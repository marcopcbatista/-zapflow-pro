...
import { Play, CheckCircle2, Users, MessageSquare, TrendingUp, Star, Menu, X, Zap, Bot, BarChart3 } from 'lucide-react';
...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-purple-800 to-indigo-900 text-white">
      <nav className={`fixed w-full z-50 transition-all duration-300 ${scrolled ? 'bg-purple-900/95 backdrop-blur-lg shadow-lg' : 'bg-transparent'}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-2xl font-bold bg-gradient-to-r from-white to-purple-200 bg-clip-text text-transparent">ZapFlow Pro</span>
            </div>
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <button onClick={handleCTA} className="bg-gradient-to-r from-pink-500 to-purple-600 px-6 py-3 rounded-full font-semibold hover:shadow-lg hover:shadow-pink-500/50 transition-all duration-300 transform hover:scale-105">
                Começar Agora
              </button>
            </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-purple-900/95 backdrop-blur-lg">
            <div className="px-4 pt-2 pb-6 space-y-3">
              ...
              <button onClick={handleCTA} className="w-full bg-gradient-to-r from-pink-500 to-purple-600 px-6 py-3 rounded-full font-semibold mt-3">
                Começar Agora
              </button>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button onClick={handleCTA} className="group bg-gradient-to-r from-pink-500 to-purple-600 px-8 py-4 rounded-full font-bold text-lg hover:shadow-2xl hover:shadow-pink-500/50 transition-all duration-300 transform hover:scale-105 flex items-center justify-center space-x-2">
            ...
            <div className="relative">
              ...
              <div className="relative bg-gradient-to-br from-purple-800/50 to-indigo-900/50 backdrop-blur-xl rounded-3xl p-8 border border-purple-500/30 shadow-2xl">
                <img src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&q=80&w=800" alt="Dashboard Preview" className="rounded-2xl shadow-2xl" />
      ...
      <section id="planos" className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { name: "Starter", price: "R$ 97", features: ["1.000 mensagens/mês", "1 número WhatsApp", "Chatbot básico", "CRM incluído"], popular: false },
              { name: "Professional", price: "R$ 297", features: ["10.000 mensagens/mês", "3 números WhatsApp", "Chatbot com IA", "Integrações ilimitadas"], popular: true },
              { name: "Enterprise", price: "R$ 997", features: ["Mensagens ilimitadas", "Números ilimitados", "IA personalizada", "API dedicada"], popular: false }
            ].map((plan, index) => (
              <div key={index} className={`relative bg-gradient-to-br from-purple-800/50 to-indigo-900/50 backdrop-blur-xl rounded-3xl p-8 border ${plan.popular ? 'border-pink-500 shadow-2xl shadow-pink-500/30 scale-105' : 'border-purple-500/30'}`}>
                {plan.popular && (
                  <div className="absolute -top-5 left-1/2 transform -translate-x-1/2">
                    <span className="bg-gradient-to-r from-pink-500 to-purple-600 px-6 py-2 rounded-full text-sm font-bold shadow-lg">🔥 MAIS VENDIDO</span>
                  </div>
                )}
                ...
                <div className="text-center mb-8">
                  ...
                  <div className="flex items-end justify-center">
                    ...
                    <span className="text-purple-300 ml-2 mb-2">/mês</span>
                  </div>
                </div>
                ...
                <button onClick={handleCTA} className={`w-full py-4 rounded-full font-bold transition-all duration-300 ${plan.popular ? 'bg-gradient-to-r from-pink-500 to-purple-600 hover:shadow-lg hover:shadow-pink-500/50 transform hover:scale-105' : 'border-2 border-purple-400 hover:bg-purple-800/30'}`}>
      ...
      <footer className="py-12 px-4 sm:px-6 lg:px-8 bg-purple-950/50">
        <div className="max-w-7xl mx-auto text-center">
          <p className="text-purple-300">© 2024 ZapFlow Pro. Todos os direitos reservados.</p>
        </div>
      </footer>
    </div>
  );
